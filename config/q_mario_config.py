...
class Mario_HRL_Config(Hierarchical_RL_Config):
    def __init__(self):
        ...
        from learning_agents.diversity_q_learning.diversity_q_learning import Diversity_Q_Learning
        self.low_agent_class = {
            'visited_bottom': Diversity_Q_Learning,
            'picked_key': Diversity_Q_Learning,
            'back_to_upper': Diversity_Q_Learning,
            'door_opened': Diversity_Q_Learning
        }
        self.agent_config = {
